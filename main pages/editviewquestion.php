...
<!-- end #sidebar1 --></div>
  ...
  ?>
	...
	<a href="editviewquestion1.php?question_id=<?php echo $row["question_id"] ?>" > 
    
    <?php echo"<br/>"; ?>
    
    Change Quesion<?php echo $row["question_id"] ?> 
    </a>
    
    <?php
       }
	?>
    <!--<a href="editviewquestion1.php?question_id=10" > Change Quesion10 
    </a>-->
