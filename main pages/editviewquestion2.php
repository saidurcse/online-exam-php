...
.twoColFixLtHdr #container {
	width: 1099px;  /* using 20px less than a full 800px width allows for browser chrome and avoids a horizontal scroll bar */
	background: #FFFFFF;
...
mysql_query("update question set question='$fques' ,answer1='$fans1' ,answer2='$fans2', answer3='$fans3' ,answer4='$fans4' ,correct_option='$fcoption'  where question_id=$question_id");
...
mysql_close($con);
  ...
  echo "<br/>";
  echo "<br/>";
  echo "Question has successfully updated in the server";
