...
<div id="container">
  ...
  <div id="sidebar1">
    ...
    " border="0" cellpadding="2">
      <tr>
        <td><a href="exam.php">Exam Page</a></td>
      </tr>
      <tr>
        <tr>
        <td><a href="logout1.php">Logout</a></td>
      </tr>
      <tr>
      </tr>
    </table>
<!-- end #sidebar1 --></div>
  <div id="mainContent">
    <h4>Welcome to exam main page</h4>
    ...
    <p>5.Students are bound to follow the rules and regulations  defined by the kiit university  and then press start button to continue Exam.</p>
    <p>&nbsp;</p>
    <!--<p><a href="exam1.php">I agree</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="exam.php">I decline</a></p>
       -->
       <form action="exam1.php" method="post">
            
        
         <input type="submit" name="start" id="start" value="Start Exam"/>       </form>
  <!-- end #mainContent --></div>
