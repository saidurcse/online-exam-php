...
<!-- end #sidebar1 --></div>
  ...
  <label>
    ...
    <span class="textfieldRequiredMsg">Integer value is required</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></label>
  </p>
  <p>
  <label>
    StudentName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="sprytextfield2">
  ...
  <label>
    TestId&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input name="test_id" type="text" id="test_id" />
  </label>
  </p>
  <p>
  <label>
    AdminId&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input name="admin_id" type="text" id="admin_id" />
  </label>
  </p> -->
  <p>
  <label>
    Username&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="sprytextfield3">
    <input type="text" name="name" id="name" />
    <span class="textfieldRequiredMsg">A value is required.</span></span></label>
  </p>
  <p>
    <label>Age&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="sprytextfield4">
  ...
  <p>
    <label >Shipping Address    
      ...
      <input type="text" name="sadd" id="sadd" />
      <span class="textfieldRequiredMsg">A value is required.</span></span></label>
  </p>
  <p>
    <label>E-mail&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="sprytextfield6">
    <input type="text" name="e-mail" id="e-mail" />
    <span class="textfieldRequiredMsg">A valid email is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></label>
  </p>
  <!--<p>
    <label>Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
