...
<!-- end #sidebar1 --></div>
  <div id="mainContent">
    ...
    <h1>Set Exam and Password </h1>
   <form action="setexam1.php" method="post">
   
   <label>Click button to generate a password for Exam 
     <input name="submit" type="submit" id="submit" value="Submit" />
    </label>
	   
   </form>
   <form action="setexam2.php" method="post">
   
   <label>Click button to erase exam main password  
